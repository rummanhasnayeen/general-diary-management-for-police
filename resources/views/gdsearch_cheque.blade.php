                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          ...
                          <form action="{{url('/')}}/gdsearchresult_cheque" method="post" onsubmit="return validateForm()" name="myForm">
                            ...
                            <font color="green">Search By Bank Name: </font><input placeholder="General Diary Number" type="text" name="gdsearch_bank_name"><br>
                            <font color="green">Search By Mobile no: </font><input placeholder="General Diary Number" type="text" name="gdsearch_mobile"><br>
                            <font color="green">Search By Account no: </font><input placeholder="General Diary Number" type="text" name="gdsearch_account_number"><br>

                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                          ...
                          <form action="{{url('/')}}/gdsearchresult_mobile" method="post" onsubmit="return validateForm()" name="myForm">
                            ...
                            <font color="green">Search By Sim no: </font><input placeholder="General Diary Number" type="text" name="gdsearch_sim"><br>
                            <font color="green">Search By Mobile no: </font><input placeholder="General Diary Number" type="text" name="gdsearch_mobile"><br>
                            <font color="green">Search By imei1 no: </font><input placeholder="General Diary Number" type="text" name="gdsearch_imei1"><br>

...
/*app-navbar-collapse{
    ...
    body{
      ...
      background-image:linear-gradient(rgba(0,0,0,0.6),rgba(0,0,0,0.6)), url(http://localhost/SMP/public/img/back.jpg);
        ...
        <div class="col-md-8 col-md-offset-2">
          <div class="panel panel-default">
            ...
            <form action="{{url('/')}}/passport"  method="POST" align="center">
              {{csrf_field() }}
              <input type="submit" name="passport" value="PASSPORT" class="btn btn-primary">

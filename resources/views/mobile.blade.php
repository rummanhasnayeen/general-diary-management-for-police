...
/*app-navbar-collapse{
    ...
    body{
      ...
      background-image: url(http://localhost/SMP/public/img/back.jpg);
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <form action="{{url('/')}}/insert_mobile" method="post">
                ...
                পিতাঃ <input type="text" name="father" size="40" placeholder="পিতা"> মাতাঃ  <input type="text" name="mother" size="40" placeholder=""><br>
                ...
                <br>
                আপনার থানায় হাজির হইয়া এই মর্মে সাধারণ ডায়েরী করার আবেদন করিতেছি যে, গত<input type="text" name="lost_date"  placeholder=""> আমার ব্যবহৃত মোবাইল হ্যান্ডসেটটি যাহার মডেল নং <input type="text" name="mobile_model"  placeholder=""><b>,  এবং </b><input type="text" name="mobile_color"  placeholder=""> রঙের। যাহার  IMEI1-<input type="text" name="imei1"  placeholder="">,IMEI2-<input type="text" name="imei2"  placeholder="">| যাহার সংযোগ সীম নং- <input type="text" name="lost_phone_number"  placeholder="">

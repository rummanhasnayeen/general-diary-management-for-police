...
বরাবর<br>
                ...
                <br>
                আপনার থানায় হাজির হইয়া এই মর্মে সাধারণ ডায়েরী করার আবেদন করিতেছি যে, গত {{$key->lost_date}} <br>আমার ব্যবহৃত মোবাইল হ্যান্ডসেটটি যাহার মডেল নং {{$key->mobile_model}}<b>,  এবং </b>{{$key->mobile_color}} রঙের।<br> যাহার  IMEI1-{{$key->imei1}} , IMEI2-{{$key->imei2}}| যাহার সংযোগ সীম নং- {{$key->sim}}
                {{$key->from_place}}
